define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'finance/finance_cash_order_history/index' + location.search,
                    // add_url: 'finance/finance_cash_order_history/add',
                    // edit_url: 'finance/finance_cash_order_history/edit',
                    // del_url: 'finance/finance_cash_order_history/del',
                    multi_url: 'finance/finance_cash_order_history/multi',
                    import_url: 'finance/finance_cash_order_history/import',
                    table: 'fin_cash_order_history',
                }
            });
