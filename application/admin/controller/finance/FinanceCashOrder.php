 ...
 * @icon fa fa-circle-o
 */
class FinanceCashOrder extends Backend
{

    /**
     * FinanceCashOrder模型对象
     * @var \app\admin\model\finance\FinanceCashOrder
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\finance\FinanceCashOrder;
